...
public class QuanLyThuVienSqlite extends SQLiteOpenHelper {
   ...
   static final int dbVersion = 1;
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        //inert du lieu mau
        String insThuThu = "INSERT INTO THUTHU VALUES('tt1','Nguyen Van liem', 'tt123'),('tt2','Nguyen Van liem', 'tt125'),('tt3','tran Van liem', 'tt345'),('admin','quangtdph42997', '123')";
        sqLiteDatabase.execSQL(insThuThu);
        String insThanhVien = "INSERT INTO THANHVIEN VALUES (1, 'Le van liem','2000'),(2, 'Tran van Liem','2002'),(3, 'Nguyen Thi Liem','1999'),(4, 'Le Thi Liem','2000')";
